...
4. Execute Steps 1–8 of the review pipeline (before each step, validate checkpoint.json artifact existence per the Checkpoint Validation Protocol in CLAUDE.md):

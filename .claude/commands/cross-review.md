...
1. Identify all documents for cross-review:
   ...
   - If multiple files in `$SECOND_REVIEW_PRIVATE_DIR/input/` → review all as a set
...
4. Save cross-document report to `$SECOND_REVIEW_PRIVATE_DIR/output/{matter_id}/round_{N}/deliverables/`

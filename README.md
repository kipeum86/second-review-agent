...
Second Review Agent is a Claude Code agent scaffold within Jinju Legal Orchestrator that acts as the final review layer before any legal document leaves the workflow. It reviews documents produced by Contract Specialist Ko Duksoo ([contract-review](https://github.com/lowtidebuild/contract-review-agent)), Legal Drafting Specialist Han Seokbong ([legal-writing](https://github.com/lowtidebuild/legal-writing-agent)), Legal Research Specialist Kim Jaesik ([general-legal-research](https://github.com/lowtidebuild/general-legal-research)), and Game Industry Law Specialist Shim Jinju ([game-legal-research](https://github.com/lowtidebuild/game-legal-research-agent)) — verifying citations, checking legal logic, evaluating writing quality, and producing redlined DOCX deliverables with tracked changes.
...
| **[second-review-agent](https://github.com/lowtidebuild/second-review-agent)** | **반성문 (Ban Seong-mun)** | **Quality review (Senior review specialist)** |

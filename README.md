...
Second Review Agent is a Claude Code agent scaffold within Legal Orchestrator that acts as the final review layer before any legal document leaves the workflow. It reviews documents produced by the Contract Review Specialist (`contract-review`), Legal Drafting Specialist (`legal-writing`), Legal Research Specialist (`general-legal-research`), and Game Industry Law Specialist (`game-legal-research`) — verifying citations, checking legal logic, evaluating writing quality, and producing redlined DOCX deliverables with tracked changes.

...
Final quality gate for AI-generated legal documents in Legal Orchestrator, powered by Claude Code.
...
Second Review Agent is a Claude Code agent scaffold within Legal Orchestrator that acts as the final review layer before any legal document leaves the workflow. It reviews documents produced by the Contract Review Specialist (`contract-review-agent`), Legal Drafting Specialist (`legal-writing-agent`), and Legal Research Specialist (`legal-research-agent`) — verifying citations, checking legal logic, evaluating writing quality, and producing redlined DOCX deliverables with tracked changes.
...
## Part of Legal Orchestrator

This agent is part of the **Legal Orchestrator** series of specialized legal workflow agents:

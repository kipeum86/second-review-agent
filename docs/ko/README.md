...
`10년차 파트너 변호사 반성문`은 법무법인 진주에서 법률 문서가 외부로 발송되기 전 최종 검토를 수행하는 Claude Code 에이전트입니다. 4개 주니어 변호사 에이전트([contract-review](https://github.com/lowtidebuild/contract-review-agent), [legal-writing](https://github.com/lowtidebuild/legal-writing-agent), [general-legal-research](https://github.com/lowtidebuild/general-legal-research), [game-legal-research](https://github.com/lowtidebuild/game-legal-research-agent))가 작성한 문서의 인용 검증, 법률 논리 점검, 작성 품질 평가를 수행하고, 추적 변경이 적용된 레드라인 DOCX를 생성합니다.
...
| 에이전트 | 용도 |
|----------|------|
| [contract-review-agent](https://github.com/lowtidebuild/contract-review-agent) | 계약서 분석 및 리스크 식별 |
| [legal-writing-agent](https://github.com/lowtidebuild/legal-writing-agent) | 법률 문서 작성 |
| [general-legal-research](https://github.com/lowtidebuild/general-legal-research) | 다관할권 법률 리서치 |
| [game-legal-research-agent](https://github.com/lowtidebuild/game-legal-research-agent) | 게임 산업 규제 리서치 |
